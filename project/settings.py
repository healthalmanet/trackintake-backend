...
PATHYATECH_BACKEND_URL = config("PATHYATECH_BACKEND_URL", default="http://localhost:9000")
PATHYATECH_API_SECRET = config("PATHYATECH_API_SECRET", default="PT_SEC_12345")
